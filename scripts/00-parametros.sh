...
NOMESERVER="pmi01bl01"
#
# Variável do Nome de Domínio do Servidor Ubuntu desse curso
# OBSERVAÇÃO IMPORTANTE: essa variável será utilizada em outras variáveis desse curso
DOMINIOSERVER="biblioteca.itauna.mg.gov.intra"
#
...
# 10. /var/lib/bind/biblioteca.itauna.mg.gov.intra.hosts = arquivo de configuração da Zona de Pesquisa Direta
# 11. /var/lib/bind/191.168.200.rev = arquivo de configuração da Zona de Pesquisa Reversas
...
DOMAINREV="200.168.191.in-addr.arpa"
#
...
# 02. less /var/lib/bind/biblioteca.itauna.mg.gov.intra.hosts = arquivo de configuração da Zona de Pesquisa Direta
# 03. less /var/lib/bind/191.168.200.rev = arquivo de configuração da Zona de Pesquisa Reversas
#
...
# 11. /etc/awstats/awstats.biblioteca.itauna.mg.gov.intra.conf = arquivo de configuração do serviço AWStats
...
AGENDAJAVAEE="https://github.com/professorjosedeassis/javaEE/raw/main/agendaadministrador.war"
#
...
# PASSWORD('123456') nova senha do usuário ocs

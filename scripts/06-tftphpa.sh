...
# 	tftp tftp.biblioteca.itauna.mg.gov.intra (IPv4 Trivial File Transfer Protocol client)
#		verbose
#		status
#		get robson.txt
#		put linux.txt
...
# 		tftp -i tftp.biblioteca.itauna.mg.gov.intra get robson.txt
# 		tftp -i tftp.biblioteca.itauna.mg.gov.intra put windows.txt
#

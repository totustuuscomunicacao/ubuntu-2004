...
#	mysql -u root -p -h mysql.biblioteca.itauna.mg.gov.intra (the MySQL command-line tool)
#
# Microsoft Windows
...
#	mysqlsh
#		\connect --mysql root@mysql.biblioteca.itauna.mg.gov.intra
#		\status
#		\quit
#
...
#	links2 http://biblioteca.itauna.mg.gov.intra (lynx-like alternative character mode WWW browser)
#
...
echo -e "Atualizando os arquivos de configuração do Apache2 e do PHP, aguarde..."
	...
	cp -v conf/lamp/awstats.biblioteca.itauna.mg.gov.intra.conf /etc/awstats/ &>> $LOG
...
sleep 5
#
echo -e "Editando o arquivo de configuração awstats.biblioteca.itauna.mg.gov.intra.conf, pressione <Enter> para continuar."
	# opção do comando read: -s (Do not echo keystrokes)
	read -s
	vim /etc/awstats/awstats.biblioteca.itauna.mg.gov.intra.conf
echo -e "Arquivo editado com sucesso!!!, continuando com o script...\n"
sleep 5
#

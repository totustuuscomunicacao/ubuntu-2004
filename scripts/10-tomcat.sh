...
#	URL: http://biblioteca.itauna.mg.gov.intra:8080
#	Manager Webapp: http://biblioteca.itauna.mg.gov.intra:8080/manager/
#	Aplicativo Agenda: http://biblioteca.itauna.mg.gov.intra:8080/agenda/
#	PhpMyAdmin: http://biblioteca.itauna.mg.gov.intra/phpmyadmin
#

...
#	sudo rpcinfo -p nfs.biblioteca.itauna.mg.gov.intra (report RPC information)
#	sudo showmount -e nfs.biblioteca.itauna.mg.gov.intra (show mount information for an NFS server)
#	sudo mkdir -v /mnt/nfs (make directories)
#	sudo mount -v nfs.biblioteca.itauna.mg.gov.intra:/mnt/nfs /mnt/nfs (mount a filesystem)
...
#	rpcinfo -p nfs.biblioteca.itauna.mg.gov.intra
#	showmount -e nfs.biblioteca.itauna.mg.gov.intra
#	mount -o anon nfs.biblioteca.itauna.mg.gov.intra:/mnt/nfs z:
#	mount
#	umount z:
#
# Windows Powershell: (Infelizmente não está funcionando corretamente, buscando solução)
#	New-PSDrive -Name W -PSProvider FileSystem -Root "\\nfs.biblioteca.itauna.mg.gov.intra:\mnt\nfs"
#	Get-PSDrive W
#	Remove-PSDrive W
#

...
#	Administration login: administrador
#	Administration password: administrador
#	Retype administration password: administrador
#	<Next>
# 06. @@Step 7 - Finish@@
#	<save>
#
...
#			Port: 9096
#			Use HTTP Basic authentication: Yes
#			API Login: administrador
#			API Password: administrador

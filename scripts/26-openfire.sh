...
#		Domínio: biblioteca.itauna.mg.gov.intra
#		Server Host Name (FQDN): pmi01bl01.biblioteca.itauna.mg.gov.intra
...
#		Endereço de e-mail do Admin: administrador@biblioteca.itauna.mg.gov.intra
#		Nova senha: 123456

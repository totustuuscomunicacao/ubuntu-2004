...
#	sudo usermod -a -G davfs2 administrador
#	sudo mkdir -v /mnt/davs (make directories)
#	sudo mount -v -t davfs -o noexec https://webdav.biblioteca.itauna.mg.gov.intra /mnt/davs/ (mount a filesystem)
#	sudo mount | grep davfs (mount a filesystem)
#	sudo umount /mnt/davs (umount a filesystem)
# Gerenciador de Arquivos Neno
#	Ctrl+L
#		davs://administrador@webdav.biblioteca.itauna.mg.gov.intra/
# Navegadores de Internet (Firefox, Chrome, Edge, etc...)
#	URL: https://webdav.biblioteca.itauna.mg.gov.intra/
#
# Windows Powershell:
#	New-PSDrive -Name X -PSProvider FileSystem -Root \\webdav.biblioteca.itauna.mg.gov.intra@SSL\webdav
#	net use W: https://webdav.biblioteca.itauna.mg.gov.intra password /USER:administrador
# Windows Explorer:
#	Este Computador
#		Computador
...
#				Endereço de Rede ou na Internet: https://webdav.biblioteca.itauna.mg.gov.intra <Avançar>;
#					Nome do usuário: administrador
#					Senha do usuário: 123456 <OK>
#				Digite o nome para este local de rede: webdav.biblioteca.itauna.mg.gov.intra <Avançar>;

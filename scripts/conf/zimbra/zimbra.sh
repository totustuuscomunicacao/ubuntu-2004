...
# 18. Create domain: [pmi01bl01.biblioteca.itauna.mg.gov.intra] biblioteca.itauna.mg.gov.intra <Enter>
# 19. Address unconfigured (**) items  (? - help) 6 <Enter>
#	19.1 Select, or 'r' for previous menu [r] 4 <Enter>
#	19.2 Password for admin@biblioteca.itauna.mg.gov.intra (min 6 characters): [XXXXXX] 123456 <Enter>
...
# 01. Acessar a URL: https://mail.biblioteca.itauna.mg.gov.intra:7071
# 02. Nome do usuário: admin
# 03. Senha: 123456 <Login>
#
# INFORMAÇÕES QUE SERÃO SOLICITADAS VIA WEB (NAVEGADOR) DO ZIMBRA WEBMAIL:
# 01. Acessar a URL: https://mail.biblioteca.itauna.mg.gov.intra
# 02. Nome do usuário: admin
# 03. Senha: 123456
